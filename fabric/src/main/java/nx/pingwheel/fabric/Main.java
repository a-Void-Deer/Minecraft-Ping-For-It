...
public class Main implements ModInitializer {
	...
	public void onInitialize() {
		...
		ServerPlayNetworking.registerGlobalReceiver(PingLocationC2SPacket.PACKET_TYPE, (packet, context) -> ServerCore.onPingLocation(context.server(), context.player(), packet));
