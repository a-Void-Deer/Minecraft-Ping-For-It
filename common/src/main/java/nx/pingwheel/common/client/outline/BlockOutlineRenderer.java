 ...
 * relative vertices with its own identity {@link PoseStack}, writes them into
 * the {@code RenderType.lines()} buffer, and never flushes: vanilla flushes
 * the lines batch later in {@code renderLevel}.
 */
