 ...
 * the ping type id must not be blank. The color is forced opaque, so a
 * 24-bit RGB value passed in always becomes {@code 0xFF000000 | color} and
 * a call site can never produce a transparent outline.
 */
