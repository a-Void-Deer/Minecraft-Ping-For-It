...
/**
 * Private copy of Apache Maven 3.9.9's ComparableVersion implementation.
 *
 * <p>It is kept in the common source set so every loader uses Maven's full
 * qualifier, separator, and numeric ordering without a runtime Maven
 * dependency.</p>
 */
public class MavenComparableVersion implements Comparable<MavenComparableVersion> {
    ...
    /** Represents a numeric item that can be represented with an int. */
    ...
    /** Represents a numeric item that can be represented with a long. */
    ...
    /** Represents a string item, usually a qualifier. */
    ...
    /** Represents a version list item, used for the global list and hyphen sub-lists. */
    ...
    @Override
    public int compareTo(MavenComparableVersion other) {
