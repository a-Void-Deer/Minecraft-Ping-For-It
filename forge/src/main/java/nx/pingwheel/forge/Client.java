...
public class Client {
	...
	public Client(FMLJavaModLoadingContext context) {
		...
		RegisterKeyMappingsEvent.getBus(this.context.getModBusGroup()).addListener(this::onRegisterKeyBindings);
	...
	private void registerReloadListener() {
		var bus = this.context.getModBusGroup();
		RegisterClientReloadListenersEvent.getBus(bus).addListener((event) -> event.registerReloadListener(new ResourceReloadListener()));
	}
